...
int main(int argc, char *argv[])
{
    ...
    fprintf(stderr, "HAETAE-%d hint-pk-view signature collection\n",
            HAETAE_MODE);
    ...
    uint32_t header[9] = {
        HINT_PK_VIEW_MAGIC,          N, K, L, M, LN, num_sigs, rec_i32,
        HAETAE_CRYPTO_PUBLICKEYBYTES};
    fwrite(header, sizeof(uint32_t), 9, fp);
    fwrite(pk, sizeof(uint8_t), HAETAE_CRYPTO_PUBLICKEYBYTES, fp);
