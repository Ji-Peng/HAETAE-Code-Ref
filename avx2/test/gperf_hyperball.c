/*
 * gperf_hyperball.c — HAETAE avx2: 球采样 gperftools CPU profiling
 *
 * 使用方法:
...
int main(void)
{
    ...
    const char *profname = "hyperball_avx2.prof";

    printf("HAETAE%d avx2: gperftools profiling %d iterations of sample_hyperball\n",
           HAETAE_MODE, N_ITERS);
